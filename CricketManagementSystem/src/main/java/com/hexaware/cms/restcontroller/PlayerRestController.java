...
//		return null;
	...
	@DeleteMapping("delete/player/name/{playerName}")
	private String deletePlayerByName(@PathVariable String playerName) {
		return service.deletePlayerByname(playerName);
	}
